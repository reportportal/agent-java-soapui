...
public class StepBasedSoapUIServiceImpl implements SoapUIService {
    ...
    public void startLaunch() {
        ...
        this.executor = Executors.newFixedThreadPool(parameters.getIoPoolSize());
    ...
    protected ReportPortal buildReportPortal(ListenerParameters parameters) {
        return ReportPortal.builder().withParameters(parameters).withExecutorService(executor).build();
    }
